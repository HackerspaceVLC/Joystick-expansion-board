...
//	joySt.throttle = 128;
//	joySt.rudder = 128;
//	joySt.hatSw1 = 9;  //setas. del 1 al 8 son las direcciones. 0 y 8 son arriba. 9 centro.
//	joySt.hatSw2 = 9;
//	joySt.buttons = 0; // 32 bits de botones. LSB!
//        botones=0;
//        botones_old=0;  
...
void loop()
{
  if(digitalRead(7)==LOW)
   {
    botones=leeRegistrosBotones();
    mandos=leeRegistrosMando();
    Serial.println(botones, BIN);
    Serial.println(mandos, BIN);
    Serial.println("------------------------------------------------");
    delay(250);    
   }
